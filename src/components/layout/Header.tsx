  ...
  return (
    <header 
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        isScrolled 
          ? "bg-white border-b border-gray-100 shadow-[0_2px_20px_rgba(0,0,0,0.03)] py-4" 
          : "bg-transparent py-8"
      }`}
    >
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div 
            ...
            className="fixed inset-0 bg-white z-[200] p-10 flex flex-col shadow-2xl"
          >
            <div className="flex justify-between items-center mb-20">
              ...
              <button onClick={() => setMobileMenuOpen(false)} className="text-remag-blue-deep hover:text-remag-teal transition-colors">
                <X size={32} />
              </button>
            </div>
              ...
              {navigation.map((item, i) => (
                ...
                >
                  <Link
                    ...
                    className="text-2xl font-display font-black uppercase tracking-tight text-remag-blue-deep hover:text-remag-teal flex items-center justify-between group transition-colors"
                  >
